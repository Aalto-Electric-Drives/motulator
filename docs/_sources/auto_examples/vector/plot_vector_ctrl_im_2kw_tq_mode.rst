...
.. "auto_examples/vector/plot_vector_ctrl_im_2kw_tq_mode.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_vector_plot_vector_ctrl_im_2kw_tq_mode.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_vector_plot_vector_ctrl_im_2kw_tq_mode.py:
...
.. image-sg:: /auto_examples/vector/images/sphx_glr_plot_vector_ctrl_im_2kw_tq_mode_001.png
   :alt: plot vector ctrl im 2kw tq mode
   :srcset: /auto_examples/vector/images/sphx_glr_plot_vector_ctrl_im_2kw_tq_mode_001.png
