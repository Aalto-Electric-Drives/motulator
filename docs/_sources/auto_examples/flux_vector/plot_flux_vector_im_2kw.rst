...
.. "auto_examples/flux_vector/plot_flux_vector_im_2kw.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_flux_vector_plot_flux_vector_im_2kw.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_flux_vector_plot_flux_vector_im_2kw.py:
...
.. image-sg:: /auto_examples/flux_vector/images/sphx_glr_plot_flux_vector_im_2kw_001.png
   :alt: plot flux vector im 2kw
   :srcset: /auto_examples/flux_vector/images/sphx_glr_plot_flux_vector_im_2kw_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 9.963 seconds)


.. _sphx_glr_download_auto_examples_flux_vector_plot_flux_vector_im_2kw.py:
