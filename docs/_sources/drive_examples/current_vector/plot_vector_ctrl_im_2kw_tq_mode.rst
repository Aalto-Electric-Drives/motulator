...
.. "drive_examples/current_vector/plot_vector_ctrl_im_2kw_tq_mode.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_drive_examples_current_vector_plot_vector_ctrl_im_2kw_tq_mode.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_drive_examples_current_vector_plot_vector_ctrl_im_2kw_tq_mode.py:
...
.. image-sg:: /drive_examples/current_vector/images/sphx_glr_plot_vector_ctrl_im_2kw_tq_mode_001.png
   :alt: plot vector ctrl im 2kw tq mode
   :srcset: /drive_examples/current_vector/images/sphx_glr_plot_vector_ctrl_im_2kw_tq_mode_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (0 minutes 6.322 seconds)


.. _sphx_glr_download_drive_examples_current_vector_plot_vector_ctrl_im_2kw_tq_mode.py:
