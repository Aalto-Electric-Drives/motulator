...
.. _sphx_glr_drive_examples_gradnet_sg_execution_times:


Computation times
=================
**02:53.588** total execution time for 9 files **from drive_examples/gradnet**:
...
.. container::
   ...
   * - :ref:`sphx_glr_drive_examples_gradnet_train_6kw_pmsyrm_curr_map_fem.py` (``train_6kw_pmsyrm_curr_map_fem.py``)
     - 00:00.000
     - 0.0
   * - :ref:`sphx_glr_drive_examples_gradnet_train_6kw_pmsyrm_flux_map_fem_no_harm.py` (``train_6kw_pmsyrm_flux_map_fem_no_harm.py``)
     - 00:00.000
     - 0.0
