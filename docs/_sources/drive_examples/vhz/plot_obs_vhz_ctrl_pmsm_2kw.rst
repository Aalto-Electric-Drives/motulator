...
.. "drive_examples/vhz/plot_obs_vhz_ctrl_pmsm_2kw.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_drive_examples_vhz_plot_obs_vhz_ctrl_pmsm_2kw.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_drive_examples_vhz_plot_obs_vhz_ctrl_pmsm_2kw.py:
...
.. image-sg:: /drive_examples/vhz/images/sphx_glr_plot_obs_vhz_ctrl_pmsm_2kw_001.png
   :alt: plot obs vhz ctrl pmsm 2kw
   :srcset: /drive_examples/vhz/images/sphx_glr_plot_obs_vhz_ctrl_pmsm_2kw_001.png
...
.. _sphx_glr_download_drive_examples_vhz_plot_obs_vhz_ctrl_pmsm_2kw.py:
