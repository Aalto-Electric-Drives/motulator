...
class ObserverBasedVHzCtrlPars(FluxTorqueReferencePars):
    ...
    alpha_f : float
        Bandwidth of the high-pass filter (rad/s).
...
class ObserverBasedVHzCtrl(Ctrl):
    ...
    def __init__(self, par, ctrl_par, T_s=250e-6):
        ...
        self.observer = SensorlessFluxObserver(par)
...
class SensorlessFluxObserver:
    ...
    This observer is a variant of [Hin2018]_. The observer gain decouples the
    ...
    mathematically equivalent to controller coordinates implementation in 
    [Tii2022]_.
