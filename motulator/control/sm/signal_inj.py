...
from motulator.control.sm.vector import CurrentCtrl, CurrentReference
...
class SignalInjection:
    ...
    the injected switching frequency signal, according to [Kim2012]_. The 
    estimate can be used in a phase-locked loop or in a state observer to 
    robustify low-speed sensorless operation.
