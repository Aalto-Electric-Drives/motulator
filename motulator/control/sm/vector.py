...
from motulator.control.common import Ctrl, ComplexPICtrl, PWM, SpeedCtrl
...
class VectorCtrl(Ctrl):
    ...
    def __call__(self, mdl):
        ...
        u_s = self._pwm.realized_voltage
        ...
        d_abc = self._pwm(self.T_s, u_s_ref, u_dc, theta_m, w_m)
...
class CurrentReference:
    ...
    References
    ----------
    .. [Bed2020] Bedetti, Calligaro, Petrella, "Analytical design and autotuning 
       of adaptive flux-weakening voltage regulation loop in IPMSM drives with
...
class SensorlessObserver:
    ...
    # pylint: disable=too-many-instance-attributes
    def __init__(self, par, w_o=2*np.pi*40, zeta_inf=.2):
        self.R_s = par.R_s
        self.L_d = par.L_d
        self.L_q = par.L_q
