...
class ObserverBasedVHzControl(DriveControlSystem):
    ...
    def output(self, fbk):
        ...
        fbk.w_r = (
            par.R_R * fbk.tau_M / (1.5 * par.n_p * psi_R_sqr) if psi_R_sqr > 0 else 0
        )
...
class FluxObserver:
    ...
    def __init__(self, par, alpha_o, b=None):
        ...
        zeta_inf = 0.2  # Damping ratio at high speeds
    ...
    def update(self, T_s, fbk):
        ...
        e_s = fbk.u_s - par.R_s * fbk.i_s - par.L_sgm * (d_i_s + 1j * fbk.w_s * fbk.i_s)
