...
#from config.ctrl_sensorless_vector_pmsm_2kW import ctrl, mdl
#from config.ctrl_sensorless_vector_syrm_7kW import ctrl, mdl
from config.ctrl_sensorless_vector_im_2kW import ctrl, mdl
#from config.ctrl_sensorless_vector_im_45kW import ctrl, mdl
#from config.ctrl_scalar_im_2kW import ctrl, mdl
