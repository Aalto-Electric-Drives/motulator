"""
5.6-kW saturated PM-SyRM, plot maps
===================================

This example demonstrates how to plot figures using the LaTeX option and save them as
PDF files. Most other plotting scripts have similar functionalities.

The flux linkage and current maps of a 5.6-kW permanent-magnet synchronous reluctance
machine (PM-SyRM, Baldor ECS101M0H7EF4) are plotted, using both the measured data from
the constant-speed test [#Arm2013]_ and fitted analytical model [#Lel2024]_. This
saturation model can capture the de-saturation phenomenon of thin iron ribs, see
[#Arm2009]_ for details.
