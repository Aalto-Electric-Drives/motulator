...
.. figure:: /control/figs/ComplexFFPI.svg
   ...
   The complex-vector gain selection is based on the paper by Briz et al. [#Bri2000]_. More details about the gain selection can be found in the :doc:`/control/drive/current_ctrl` section.
