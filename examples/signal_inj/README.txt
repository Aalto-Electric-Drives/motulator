...
These examples demonstrate a ssquare-wave signal injection for low-speed 
operation [#Kim2012]_. A phase-locked loop is used to track the rotor position. 
For a wider speed range, signal injection could be combined to a model-based 
